	...
	DEOTHEMES.initialize = {
			...
			document.addEventListener("keydown", function (e) {
				...
				if (body.classList.contains("showing-modal")) {
					...
					if (body.classList.contains("showing-search-modal")) {
						let search = document.querySelectorAll(".blockst-menu-search");
		...
		menuSearch: function () {
			let search = document.querySelectorAll(
				".blockst-menu-search:not(.eversor-menu-search)"
			);
			...
			for (var i = 0; i < search.length; i++) {
				let trigger = search[i].querySelector(".blockst-menu-search__trigger"),
