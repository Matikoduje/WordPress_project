...
(function () {
  ...
  DEOTHEMES.initialize = {
      ...
      document.addEventListener("keydown", function (e) {
        ...
        if (body.classList.contains("showing-modal")) {
          ...
          if (body.classList.contains("showing-search-modal")) {
            var search = document.querySelectorAll(".blockst-menu-search");
    ...
    menuSearch: function menuSearch() {
      var search = document.querySelectorAll(".blockst-menu-search:not(.eversor-menu-search)");
      ...
      var _loop = function _loop() {
        var trigger = search[i].querySelector(".blockst-menu-search__trigger"),
            modal = search[i].querySelector(".blockst-menu-search-modal"),
            inner = search[i].querySelector(".blockst-menu-search-modal__inner"),
        ...
        trigger.addEventListener("click", function (e) {
          ...
          modal.classList.add("blockst-menu-search-modal--is-open");
      ...
      function closeModal(modal) {
        ...
        modal.classList.remove("blockst-menu-search-modal--is-open");
